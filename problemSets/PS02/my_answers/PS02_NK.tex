...
\title{Problem Set 2}
\title{Answer Sheet - Problem 2 - Nour Kebbi - 23350337}
...
\end{itemize}
\VerbatimInput[firstline = 6, lastline = 11]{PS02_NK.R}
...
\VerbatimInput[firstline = 12, lastline = 14]{PS02_NK.R}
...
\VerbatimInput[firstline = 15, lastline = 23]{PS02_NK.R}
...
\VerbatimInput[firstline = 24, lastline = 27]{PS02_NK.R}
\end{enumerate}
...
\begin{enumerate}
	...
	\VerbatimInput[firstline = 30, lastline = 33]{PS02_NK.R}
	...
	\VerbatimInput[firstline = 35, lastline = 38]{PS02_NK.R}
	...
	\VerbatimInput[firstline = 39, lastline = 42]{PS02_NK.R}
	\includegraphics[width = 0.8\textwidth]{figure_3.png}
	\item Create a boxplot of the number of official members by year and region.
	\VerbatimInput[firstline = 43, lastline = 46]{PS02_NK.R}
